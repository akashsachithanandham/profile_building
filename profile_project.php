...
if (isset($_POST['submit'])){
    ...
    header("Location:project_edit.php?pid=".$pid);
    }
    ...
    $pid = mysqli_real_escape_string($conn, $_REQUEST['pid']);
    $sql = "DELETE FROM   profile_project  WHERE pid='$pid'";
...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <button class="btn btn-default" type="submit" name="submit2">Add Another</button>
      </div></div>
      <div class="form-group col-md-6">
      <div class=" modal-footer d-flex center-block justify-content-center ">

...
else
{
   $duration = mysqli_real_escape_string($conn, $_REQUEST['duration']);
    ...
    $sql = "UPDATE  profile_intern  SET pname='$name', obj='$obj', tools='$Tools', duration='$duration',outcome='$Outcome' where pid='$pid'";
    ...
    $sql = "SELECT * from profile_intern where pid='$pid'";
...
<div class="form-row">
        ...
        <div class="form-row">
             ...
             <div class="form-group col-md-12">
                <label for="pname">Organization/Location Name: </label>
